...
public abstract class GameObject {
    ...
    public BoxCollider boxCollider = new BoxCollider();
    ...
    public void destroySelf() {
        boxCollider.setPosition(0, 0);
        boxCollider.setSize(0, 0);
        OBJECT.remove(this);
    }
    ...
    public void tick() {
        ...
        if (init) {
            ...
            update();
            if(dir != Dir.None){
                velX = lengthdirX(speed, dir.getId()*90);
                velY = lengthdirY(speed, dir.getId()*90);
            } else {
