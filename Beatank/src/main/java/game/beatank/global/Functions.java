package game.beatank.global;

import game.beatank.enums.Dir;
import game.beatank.manager.BoxCollider;
import game.beatank.manager.CircleCollider;
...
public class Functions {
    ...
    public static int obstacle_id[] = {5, 6, 7, 8, 9, 16, 17, 18, 19, 21, 22, 23, 24, 25, 26, 27, 28, 29};
    public static int grid_size = 45;
    public static int map_count = 1;
    ...
    public static Dir toDir(char k) {
        switch (k) {
            case 'R' -> {
                return Dir.Right;
            }
